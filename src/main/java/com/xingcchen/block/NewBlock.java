...
public class NewBlock {
    ...
    public static final Block DEEPSLATE_CORN_ORE = new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_DIAMOND_ORE), UniformIntProvider.create(2,5));
